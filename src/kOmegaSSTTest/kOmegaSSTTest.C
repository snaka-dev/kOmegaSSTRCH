...
void kOmegaSSTTest<BasicTurbulenceModel>::correctNut(const volScalarField& S2)
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTTest<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
kOmegaSSTTest<BasicTurbulenceModel>::kOmegaSSTTest
(
